...
public class TetrisRotateLeftItem extends ClickableItem {
    private final TetrisGame game;
    public TetrisRotateLeftItem(TetrisGame game, ItemStack item) {
    ...
    public void onClick(ItemStack item) {
        if (this.game.getCurrent() != null) this.game.getCurrent().setRotation(this.game.getCurrent().getRotation().getLeft());
    }
}
